...
class Sender(db.Model):
    ...
    organisation_number = db.Column(String(16), index = true, nullable = False)
    phone_number = db.Column(String(16), index = True, nullable = False)
    account_number = db.Column(String(16), index = True, nullable = False)
    payment_method = db.Column(String(16), index = True, nullable = False)
    complaint_link = db.Column(String(86), index = True, nullable = False)
...
class Service(db.Model):
    ...
    price_per = db.Column(db.Double, nullable = False)
    price_total = db.Column(db.Double, nullable = False)
